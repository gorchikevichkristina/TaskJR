...
public class Level7x5x2 {
    ...
    */
    ...
    public static void printCityPopulation(String city, double population) {
        ...
        System.out.println("В то время как в самом густонаселенном городе " + Level7x5x2.city + " население составляет " + Level7x5x2.population + " млн человек.");
    }
}
